...
import com.yogeshpaliyal.shared.analytics.AnalyticsEvents
import com.yogeshpaliyal.shared.analytics.AnalyticsManager
import com.yogeshpaliyal.shared.analytics.AnalyticsParams
import com.yogeshpaliyal.shared.data.DeeprTag
...
import com.yogeshpaliyal.shared.ui.screens.home.DeeprItem
import com.yogeshpaliyal.shared.ui.screens.home.MenuItem
import com.yogeshpaliyal.shared.ui.screens.home.ViewType
import com.yogeshpaliyal.shared.ui.screens.home.formatDateTime
...
import deepr.shared.generated.resources.add_to_favourites
import deepr.shared.generated.resources.back
import deepr.shared.generated.resources.delete
import deepr.shared.generated.resources.edit
import deepr.shared.generated.resources.last_opened
import deepr.shared.generated.resources.load_more_tags
import deepr.shared.generated.resources.no_favourites_description
import deepr.shared.generated.resources.no_favourites_found
import deepr.shared.generated.resources.no_links_saved_yet
import deepr.shared.generated.resources.no_links_with_tags
import deepr.shared.generated.resources.no_links_with_tags_description
import deepr.shared.generated.resources.no_search_results
import deepr.shared.generated.resources.no_search_results_description
import deepr.shared.generated.resources.open_with
import deepr.shared.generated.resources.remove_from_favourites
import deepr.shared.generated.resources.save_your_link_below
import deepr.shared.generated.resources.show_less_tags
import deepr.shared.generated.resources.show_qr_code
                        ...
                        if ((selectedTags?.size ?: 0) > 9) {
                            TextButton(
                                ...
                                Text(
                                    text =
                                        if (tagsExpanded) {
                                            stringResource(Res.string.show_less_tags)
                                        } else {
                                            stringResource(Res.string.load_more_tags, hiddenTagsCount)
                                        },
                ...
                val (icon, titleRes, descriptionRes) =
                    when {
                        ...
                        isTagFilterActive ->
                            Triple(
                                TablerIcons.Tag,
                                Res.string.no_links_with_tags,
                                Res.string.no_links_with_tags_description,
                            )

                        isFavouriteFilterActive ->
                            Triple(
                                TablerIcons.Link,
                                Res.string.no_favourites_found,
                                Res.string.no_favourites_description,
                            )

                        else ->
                            Triple(
                                TablerIcons.Link,
                                Res.string.no_links_saved_yet,
                                Res.string.save_your_link_below,
                            )
                    }
